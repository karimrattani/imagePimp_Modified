...
public class NPCA{
  ...
  int dim;
  int[][] clusterColor;
  NPCA(Image imageIn,int[][][] input,int cluster, double fuzziness){
  ...
  public Image get_NPCA(){
    ...
    while(true){
       ...
       if(ImageTools.compareArray(membership,temp_membership,term) || max==1000){
         ...
         kCenters=get_Cluster_Center(poss);
       }
  ...
  private double[][] get_Cluster_Center(double[][][] poss){
    double[][] kCenters = new double[this.cluster][dim];
